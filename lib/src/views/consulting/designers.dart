...
class Designers extends StatefulWidget {
  final bool isOnline;
  const Designers({super.key, required this.isOnline});
...
class _DesignersState extends State<Designers> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(
            () => controller.designerLoading.value
            ? const CommonLoading()
            : controller.designerList.isEmpty
            ? const CommonEmpty(title: 'Designers')
            : GridView.builder(
          shrinkWrap: true,
          gridDelegate:
          ...
          itemBuilder: (_, int index) {
            final data = controller.designerList[index];
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (BuildContext context) =>
                        DesignerDetail(data: data, isOnline: widget.isOnline),
                  ),
                );
              },
              child: Container(
