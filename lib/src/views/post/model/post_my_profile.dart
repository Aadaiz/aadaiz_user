...
class MyPostProfile {
  ...
  factory MyPostProfile.fromJson(String str) => MyPostProfile.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MyPostProfile.fromMap(Map<String, dynamic> json) => MyPostProfile(
    status: json["status"],
...
class Data {
  ...
  factory Data.fromMap(Map<String, dynamic> json) => Data(
    ...
    savedPosts: json["saved_posts"] == null ? null : SavedPosts.fromMap(json["saved_posts"]),
  );
...
class Posts {
  ...
  factory Posts.fromMap(Map<String, dynamic> json) => Posts(
    ...
    data: json["data"] == null ? [] : List<PostsDatum>.from(json["data"]!.map((x) => PostsDatum.fromMap(x))),
...
class PostsDatum {
  ...
  factory PostsDatum.fromJson(String str) => PostsDatum.fromMap(json.decode(str));
...
class SavedPosts {
  ...
  factory SavedPosts.fromJson(String str) => SavedPosts.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SavedPosts.fromMap(Map<String, dynamic> json) => SavedPosts(
    currentPage: json["current_page"],
    data: json["data"] == null ? [] : List<SavedPostsDatum>.from(json["data"]!.map((x) => SavedPostsDatum.fromMap(x))),
    firstPageUrl: json["first_page_url"],
    from: json["from"],
    lastPage: json["last_page"],
    lastPageUrl: json["last_page_url"],
...
class SavedPostsDatum {
  ...
  factory SavedPostsDatum.fromJson(String str) => SavedPostsDatum.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SavedPostsDatum.fromMap(Map<String, dynamic> json) => SavedPostsDatum(
    id: json["id"],
    userId: json["user_id"],
    postId: json["post_id"],
    isSaved: json["is_saved"],
