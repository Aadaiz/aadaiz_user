...
class HomeRepository {
  ...
  Future<dynamic> getBannerList() async {
    ...
    final response = await _http.get("${Api.getBannerList}?token=$token");
    final BannerListRes res = BannerListRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> getGender() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final token = prefs.getString("token");
    final response = await _http.get("${Api.gender}?token=$token");
    final GenderRes res = GenderRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> getCategoryData(id) async {
    ...
    final response = await _http.get(
      "${Api.categoryData}?cat_id=$id&token=$token",
    );
    final CategoryDataRes res = CategoryDataRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> getProductList({
    ...
    final token = prefs.getString("token");
    final response = await _http.get(
      "${Api.productList}?p_cat_id=$id&price=$price&price_range=$range&rating=$rating&filter_category_id=$filterCategory&keywords=$keyword&banner_id=$bannerId"
      "&token=$token&page=$page",
    );
    final ProductListRes res = ProductListRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> getTailorList({id, page, dynamic city}) async {
    ...
    final token = prefs.getString("token");
    final response = await _http.get(
      "${Api.tailorList}?p_sub_cat_id=$id&city=$city&token=$token&page=$page"
      "&token=$token&page=$page",
    );
    final TailorListRes res = TailorListRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> getFilters() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final token = prefs.getString("token");
    final response = await _http.get("${Api.filter}?token=$token");
    final FilterRes res = FilterRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> favoriteList() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final token = prefs.getString("token");
    final response = await _http.get("${Api.favorite}?token=$token");
    final FavoriteListRes res = FavoriteListRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> couponList() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final token = prefs.getString("token");
    final response = await _http.get("${Api.coupon}?token=$token");
    final CouponListRes res = CouponListRes.fromMap(jsonDecode(response));
    return res;
  }
  ...
  Future<dynamic> reviewList(value, id, page) async {
    ...
    final token = prefs.getString("token");
    final response = await _http.get(
      "${Api.review}?action=list&$value=$id&token=$token&page=$page",
    );
    final ReviewListRes res = ReviewListRes.fromMap(jsonDecode(response));
    return res;
  }
