...
class Datum {
  ...
  factory Datum.fromMap(Map<String, dynamic> json) => Datum(
    ...
    materialSubTitle: json["material_sub_title"],
    materialImage: json["material_image"],
    materialTotal: json["material_total"],
  ...
  Map<String, dynamic> toMap() => {
    ...
    "material_sub_title": materialSubTitle,
