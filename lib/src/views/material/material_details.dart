...
class _MaterialDetailsState extends State<MaterialDetails> {
  ...
  void initState() {
    super.initState();
    log('cartQuantityin initstate :$cartQuantity');
                        ...
                        Positioned(
                          ...
                          child: InkWell(
                            onTap: () {
                              setState(() {
                                widget.data.isLiked =
                                    widget.data.isLiked == 0 ? 1 : 0;
                                MaterialController.to.likeList[widget.index];
                              });
                              HomeController.to.addFavorite(
                                'material_id',
                                widget.data.id,
                              );
                              MaterialController.to.getMaterials(
                                isRefresh: true,
                              );
                            },
                            child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (cartQuantity != 0 || isInCart)
                          Obx(() {
                            final isInCart =
                            MaterialController.to.isItemInCart(widget.data.id);
                            final qty =
                            MaterialController.to.getItemQuantity(widget.data.id);
