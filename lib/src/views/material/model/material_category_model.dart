...
class MaterialCategoryListRes {
  bool? success;
  dynamic message;
  List<Fabric>? fabric;

  MaterialCategoryListRes({
    this.success,
    this.message,
    this.fabric,
  });

  factory MaterialCategoryListRes.fromJson(String str) => MaterialCategoryListRes.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory MaterialCategoryListRes.fromMap(Map<String, dynamic> json) => MaterialCategoryListRes(
